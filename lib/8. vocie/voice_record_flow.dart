...
class _VoiceRecordingScreenState extends State<VoiceRecordingScreen> {
  ...
  /// 녹음용 대본.
  ///
  /// 낭독이 아니라 '말' 이 나와야 목소리가 제대로 담긴다. 그래서
  ///  - 호칭을 넣지 않는다. '엄마' 로 시작하면 며느리·사위·손주에게는 남의
  ///    말이 되어 읽는 순간 톤이 굳는다.
  ///  - 실제 통화 흐름(인사 → 근황 → 물음 → 당부 → 마무리)을 따라간다.
  ///    읽다 보면 말이 나오는 순서다.
  ///  - '사랑해요' 같은 낯간지러운 말은 넣지 않는다. 소리 내 읽기 부담스러워
  ///    끝맺음에서 목소리가 딱딱해진다.
  ///  - 안내대로 60초를 채울 만큼 쓴다. 모자라면 늘어지거나 되풀이하게 되고,
  ///    그 부분에서 톤이 평평해진다.
  static const _script =
      '저예요. 그동안 잘 지내셨어요?\n\n'
      '여기는 아침저녁으로 좀 쌀쌀해졌어요. 낮에는 또 볕이 좋고요. '
      '이런 날씨에 감기 걸리기 딱 좋으니까, 얇은 거라도 하나 걸치고 계세요.\n\n'
      '오늘 점심에 된장찌개를 먹었는데, 예전에 해주시던 그 맛이 자꾸 '
      '생각나더라고요. 두부를 큼직하게 썰어 넣으셨잖아요. 그게 참 맛있었어요.\n\n'
      '요즘 잠은 잘 주무세요? 새벽에 자꾸 깨시면, 낮에 조금이라도 걸으시는 게 '
      '좋대요. 날 좋을 때 마당이라도 한 바퀴 돌고 오세요.\n\n'
      '이번 주말에 시간 내서 한번 갈게요. 드시고 싶은 거 있으면 미리 '
      '말씀해 주세요. 오는 길에 사 갈게요.\n\n'
      '그럼 오늘도 잘 보내시고요. 이따 또 연락드릴게요.';
        ...
        child: _PhonePadding(
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text('60초 이상 읽어주세요', style: _caption()),
                  const Spacer(),
                  Text(
